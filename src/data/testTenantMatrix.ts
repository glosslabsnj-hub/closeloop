...
const dispatchTenants: TestTenantConfig[] = [
  ...
  },
  {
    slug: "test-locksmith",
    name: "24/7 Lock & Key",
    address: "321 Lockout Lane, Philadelphia, PA 19101",
    timezone: "America/New_York",
    business_mode: "dispatch",
    industry: "locksmith",
    enabled_modules: ["ai_voice", "instant_text_back", "dispatch_queue", "eta_tracking"],
    ...
    hipaa_mode: false,
    scenario: "On-site locksmith, no dropoff address, car + residential lockouts",
    scenarioTags: ["locksmith", "on-site", "emergency"],
    communicationPrefs: {
      aiBookingMode: "auto_book",
      missedCallBehavior: "both",
      unknownQuestionBehavior: "try_help",
    },
    seedData: { callCount: 8, faqCount: 4, serviceCount: 4, dispatchJobCount: 6 },
  },
  {
    slug: "test-medical-transport",
    name: "CareRide Medical Transport",
    address: "500 Health Pkwy, Tampa, FL 33601",
    timezone: "America/New_York",
    business_mode: "dispatch",
    industry: "medical_transport",
    enabled_modules: ["ai_voice", "instant_text_back", "dispatch_queue", "eta_tracking"],
    capabilities_json: {
      ai_voice: true,
      instant_text_back: true,
    ...
    hipaa_mode: false,
    scenario: "Non-emergency medical transport, wheelchair + stretcher, scheduled + round-trip",
    scenarioTags: ["medical-transport", "wheelchair", "scheduled", "fleet"],
    communicationPrefs: {
      aiBookingMode: "auto_book",
      missedCallBehavior: "both",
      unknownQuestionBehavior: "offer_callback",
    },
    seedData: { callCount: 6, faqCount: 5, serviceCount: 3, dispatchJobCount: 5 },
  },
  {
    slug: "test-cleaning-dispatch",
    name: "Sparkle Pro Cleaning",
    address: "789 Clean St, Austin, TX 78701",
    timezone: "America/Chicago",
    business_mode: "dispatch",
    industry: "cleaning",
    enabled_modules: ["ai_voice", "instant_text_back", "dispatch_queue"],
    capabilities_json: {
      ai_voice: true,
      instant_text_back: true,
      dispatch_queue: true,
    ...
    hipaa_mode: false,
    scenario: "Scheduled cleaning dispatch, residential + commercial, recurring service",
    scenarioTags: ["cleaning", "scheduled", "recurring", "residential"],
    communicationPrefs: {
      aiBookingMode: "auto_book",
      missedCallBehavior: "text_only",
      unknownQuestionBehavior: "try_help",
    },
    seedData: { callCount: 5, faqCount: 4, serviceCount: 4, dispatchJobCount: 4 },
  },
  {
    slug: "test-pest-control",
    name: "BugShield Pest Control",
    address: "456 Critter Ave, Phoenix, AZ 85001",
    timezone: "America/Phoenix",
    business_mode: "dispatch",
    ...
    hipaa_mode: false,
    scenario: "Scheduled pest control, one-time + recurring treatments, safety questions for pets/children",
    scenarioTags: ["pest-control", "scheduled", "recurring", "safety"],
    communicationPrefs: {
      aiBookingMode: "auto_book",
      missedCallBehavior: "both",
      unknownQuestionBehavior: "try_help",
    },
    seedData: { callCount: 6, faqCount: 5, serviceCount: 5, dispatchJobCount: 4 },
  },
  {
    slug: "test-junk-removal",
    name: "Haul It Away",
    address: "999 Dumpster Dr, Portland, OR 97201",
    timezone: "America/Los_Angeles",
    business_mode: "dispatch",
    industry: "junk_removal",
    enabled_modules: ["ai_voice", "instant_text_back", "dispatch_queue", "pricing_rules"],
    capabilities_json: {
      ai_voice: true,
      instant_text_back: true,
      dispatch_queue: true,
    ...
    hipaa_mode: false,
    scenario: "Junk removal dispatch, volume-based pricing, stairs/accessibility considerations",
    scenarioTags: ["junk-removal", "scheduled", "volume-pricing"],
    communicationPrefs: {
      aiBookingMode: "auto_book",
      missedCallBehavior: "text_only",
      unknownQuestionBehavior: "offer_callback",
    },
    seedData: { callCount: 5, faqCount: 4, serviceCount: 3, dispatchJobCount: 4 },
  },
];
