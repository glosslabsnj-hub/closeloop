...
const serviceTenants: TestTenantConfig[] = [
  ...
  },
  {
    ...
    seedData: {
      ...
      bookingCount: 5,
      customCallSessions: [
        { caller_phone: "+14075550001", outcome: "booked", summary: "Customer called about green pool — heavy algae bloom after two weeks without service. Quoted Green-to-Clean starting at $350, same-day availability confirmed. Emergency service booked for this afternoon.", lead_score: "hot", followup_status: "completed", hours_ago: 2, duration_seconds: 195 },
        { caller_phone: "+14075550002", outcome: "booked", summary: "New homeowner just moved in, inherited a saltwater pool. Wants to understand their system. Signed up for Monthly Maintenance Plan at $150/month including all chemicals. First visit scheduled for Monday.", lead_score: "hot", followup_status: "completed", hours_ago: 5, duration_seconds: 225 },
        { caller_phone: "+14075550003", outcome: "followup", summary: "Customer comparing prices for weekly pool service. Currently paying $140/week elsewhere. Explained Monthly Plan at $150 includes chemicals (competitor charges extra). Interested — wants to think it over. Follow-up in 48 hours.", lead_score: "warm", followup_status: "new", hours_ago: 8, duration_seconds: 165 },
        { caller_phone: "+14075550004", outcome: "booked", summary: "Returning customer called to schedule spring pool opening. Pool was closed since November. Pool Opening service booked for next Saturday at 9am. Confirmed 120-minute appointment.", lead_score: "warm", followup_status: "completed", hours_ago: 12, duration_seconds: 140 },
        { caller_phone: "+14075550005", outcome: "booked", summary: "Customer's pool pump is making loud grinding noise — suspected bearing failure. Diagnosed as equipment repair, quoted $200+ with upfront estimate. Repair appointment scheduled for tomorrow morning.", lead_score: "hot", followup_status: "completed", hours_ago: 18, duration_seconds: 180 },
        { caller_phone: "+14075550006", outcome: "followup", summary: "Customer asking about salt cell conversion — currently has chlorine pool and wants to switch to saltwater. Explained Salt System Service at $125, full conversion quote needed onsite. Callback scheduled for Thursday.", lead_score: "warm", followup_status: "new", hours_ago: 24, duration_seconds: 150 },
        { caller_phone: "+14075550007", outcome: "lost", summary: "Customer called asking if we service pools in Daytona Beach. Location is 65 miles from Orlando — outside our 25-mile service area. Could not accommodate. Call ended without referral.", lead_score: "cool", followup_status: "lost", hours_ago: 30, duration_seconds: 75 },
        { caller_phone: "+14075550008", outcome: "booked", summary: "Condo HOA manager called to inquire about commercial pool service for 3 units. Scheduled an onsite visit to assess all three pools and provide a custom recurring service quote.", lead_score: "hot", followup_status: "completed", hours_ago: 36, duration_seconds: 210 },
        { caller_phone: "+14075550009", outcome: "followup", summary: "Customer with above-ground pool asking about weekly cleaning. Explained we service most above-ground pools. Sent service area confirmation and pricing. Waiting for them to call back to book.", lead_score: "warm", followup_status: "new", hours_ago: 42, duration_seconds: 120 },
        { caller_phone: "+14075550010", outcome: "booked", summary: "Customer needs pool closed for winter — heading north for the season. Pool Closing service booked for next Friday at 10am. Customer also signed up for Monthly Maintenance Plan to resume in April.", lead_score: "warm", followup_status: "completed", hours_ago: 48, duration_seconds: 175 },
      ],
      customServices: [
