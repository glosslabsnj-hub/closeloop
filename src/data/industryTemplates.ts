// Industry-specific service templates, context fields, FAQs, and objection handlers for Flux Receptionist
...
export const industryConfigs: Record<ExtendedIndustryType, IndustryConfig> = {
  ...
  pool_service: {
    ...
    icon: '🏊',
    services: [
      { name: 'Weekly Cleaning', duration: 45, price: 125, priceType: 'fixed', description: 'Skimming, brushing, vacuuming, chemical test & balance, equipment check', popularityRank: 1 },
      { name: 'Monthly Maintenance Plan', duration: 45, price: 150, priceType: 'fixed', description: 'Weekly or bi-weekly visits, all chemicals included, priority scheduling', popularityRank: 2 },
      { name: 'Chemical Balancing', duration: 60, price: 75, priceType: 'fixed', description: 'pH, chlorine, alkalinity, and stabilizer test and adjustment', popularityRank: 3 },
      { name: 'Pool Opening', duration: 120, price: 250, priceType: 'fixed', description: 'Spring opening — remove cover, reconnect equipment, balance water', popularityRank: 4 },
      { name: 'Pool Closing', duration: 120, price: 250, priceType: 'fixed', description: 'Winterization — blow out lines, add antifreeze, cover pool', popularityRank: 5 },
      { name: 'Green-to-Clean / Algae Treatment', duration: 180, price: 350, priceType: 'starting_at', description: 'Shock treatment, algaecide, brush, vacuum to waste — restore clear water', popularityRank: 6 },
      { name: 'Filter Cleaning', duration: 45, price: 85, priceType: 'fixed', description: 'DE, cartridge, or sand filter cleaning and inspection', popularityRank: 7 },
      { name: 'Equipment Repair', duration: 120, price: 200, priceType: 'starting_at', description: 'Pump, motor, filter, timer, valve diagnosis and repair', popularityRank: 8 },
      { name: 'Heater Repair', duration: 120, price: 200, priceType: 'starting_at', description: 'Gas, electric, or heat pump heater diagnosis and repair', popularityRank: 9 },
      { name: 'Salt System Service', duration: 60, price: 125, priceType: 'fixed', description: 'Salt cell cleaning, inspection, and calibration', popularityRank: 10 },
      { name: 'Tile & Surface Cleaning', duration: 120, price: 175, priceType: 'starting_at', description: 'Waterline tile scrubbing, calcium removal, surface brushing', popularityRank: 11 },
      { name: 'Pool Inspection', duration: 60, price: 100, priceType: 'fixed', description: 'Full equipment and water quality inspection with written report', popularityRank: 12 },
      { name: 'Acid Wash', duration: 240, price: 400, priceType: 'starting_at', description: 'Drain, acid wash plaster surface, refill and balance', popularityRank: 13 },
      { name: 'Leak Detection', duration: 90, price: 200, priceType: 'fixed', description: 'Pressure test and dye test to locate pool or plumbing leaks', popularityRank: 14 },
    ],
    contextFields: [
    ...
    faqs: [
      { question: "What are your business hours?", answer: "We service pools Monday through Saturday. Same-day or next-day service is usually available for urgent water quality issues like green water." },
      { question: "How often should my pool be cleaned?", answer: "We recommend weekly service for most pools to maintain safe water chemistry and prevent algae buildup. Bi-weekly works for pools with light use or covered pools." },
      { question: "Do you offer monthly service contracts?", answer: "Yes! Our monthly maintenance plan includes recurring visits with all chemical testing and balancing included. It's our most popular option and saves you money vs. one-off visits." },
      { question: "What does weekly service include?", answer: "Each visit includes skimming the surface, brushing the walls and steps, vacuuming the floor, testing and balancing all water chemistry, and a quick equipment check." },
      { question: "What chemicals do you use?", answer: "We use professional-grade chlorine, algaecides, pH balancers, alkalinity adjusters, and clarifiers — all EPA-compliant and appropriate for your pool type." },
      { question: "Do you service saltwater pools?", answer: "Yes! We service both traditional chlorine pools and saltwater (salt-chlorine generator) pools. We can inspect, clean, and service your salt cell." },
      { question: "Can you repair pool heaters?", answer: "Yes, we repair gas, electric, and heat pump pool heaters. We'll diagnose the problem first and give you an upfront quote before any repair work begins." },
      { question: "Do you service hot tubs and spas?", answer: "Yes, we service hot tubs and spas in addition to swimming pools. Just let us know what type of unit you have when you book." },
      { question: "What about winter / off-season maintenance?", answer: "We offer professional pool closing to protect your equipment over winter and a spring opening to get your pool swim-ready. Both are strongly recommended to extend the life of your pool." },
      { question: "Do you require a deposit?", answer: "We may require a deposit for larger jobs like acid washes or equipment repairs. Routine service visits are invoiced after each visit." },
      { question: "Are you licensed and insured?", answer: "Yes, fully licensed and insured. Our technicians are certified pool operators with hands-on experience servicing all pool types and equipment brands." },
      { question: "What's your cancellation policy?", answer: "We ask for 24 hours notice if you need to reschedule. For recurring service, we'll always send a reminder before your scheduled visit." },
    ],
    objections: [
      ...commonObjections,
      { objection: "I can maintain my own pool", response: "Many homeowners do! But consistent chemical balance is trickier than it looks — one off week can lead to algae that costs hundreds to fix. We save you time and prevent those surprise problems." },
      { objection: "I already have a pool service", response: "That's great! If you're ever looking to switch or want a second opinion on a repair quote, we're happy to do a free inspection. No pressure." },
      { objection: "Pool maintenance is too expensive", response: "We hear that! But consider that a green pool or damaged pump can cost $500-$2,000+ to fix. Our maintenance plans start at $125/week — chemicals included — so there are no surprise bills." },
      { objection: "It's only seasonal", response: "Exactly why we offer seasonal packages. Pool opening, weekly summer service, and winterization bundled at a discount. Most clients get more swim time because their pool is always ready to go." },
    ],
    defaultPolicies,
  },
  moving: {
