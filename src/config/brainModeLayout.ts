...
const SALES_LAYOUT: ModeLayout = {
  tabs: [
    ...
    },
    {
      ...
      titleKey: "servicesCategoryTitle",
      groups: [
        { key: "your-catalog", label: "Your Offerings", itemIds: ["catalog"] },
        { key: "pricing-options", label: "Pricing & Packages", itemIds: ["service-packages"] },
        { key: "other-offerings", label: "Additional Products", itemIds: ["additional-services"] },
      ],
      completionSections: ["services"],
    },
    {
      section: "operations",
      label: "How You Operate",
      description: "Showroom, coverage & notifications",
      icon: Calendar,
      order: 3,
      groups: [
        ...
        { key: "delivery", label: "Lead & Appointment Alerts", itemIds: ["booking-delivery", "callback-delivery"] },
      ],
      completionSections: ["coverage"],
    },
    {
