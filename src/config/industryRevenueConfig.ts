...
export const INDUSTRY_REVENUE_CONFIG: Record<BusinessMode, IndustryRevenueConfig> = {
  service: {
    ...
    cancelledStatuses: ["canceled", "cancelled", "no_show"],
    ...
    emptyStateEncouragement: "The average Flux Receptionist service business sees their first AI-booked appointment within 48 hours",
  ...
  dispatch: {
    ...
    emptyStateEncouragement: "The average Flux Receptionist dispatch business sees their first AI-dispatched job within 48 hours",
    celebratoryTone: true,
  ...
  food: {
    ...
    emptyStateEncouragement: "The average Flux Receptionist restaurant sees their first AI-placed order within 48 hours",
    celebratoryTone: true,
  ...
  medical: {
    ...
    emptyStateEncouragement: "The average Flux Receptionist medical practice sees their first AI-scheduled appointment within 48 hours",
  ...
  general: {
    ...
    emptyStateEncouragement: "The average Flux Receptionist business sees their first AI-booked entity within 48 hours",
    celebratoryTone: true,
  ...
  sales: {
    ...
    emptyStateEncouragement: "The average Flux Receptionist sales business sees their first AI-scheduled appointment within 48 hours",
    celebratoryTone: true,
