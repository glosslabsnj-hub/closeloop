...
export function HelpGuidePhone({ searchQuery = "" }: HelpGuidePhoneProps) {
  ...
  const sections = [
        ...
        <div className="space-y-4">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            <div className="p-4 rounded-lg border bg-card">
              ...
              <p className="text-sm text-muted-foreground">
                Use your Flux Receptionist number as a dedicated booking line
              </p>
            </div>
          </div>
        </div>
    ...
    {
      id: "your-number",
      title: "Your Flux Receptionist Number",
      content: (
        <div className="space-y-4">
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <p className="text-muted-foreground">
            When someone calls and you can't answer, Flux Receptionist can automatically send them a 
