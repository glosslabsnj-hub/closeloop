...
export function IntegrationsSection() {
  return (
    <section className="py-24 md:py-32 relative overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_50%_40%_at_50%_100%,hsl(230_70%_62%/0.05),transparent)] pointer-events-none" />
          ...
          <div className="flex flex-wrap justify-center gap-6 sm:gap-10 mt-14 pt-10 border-t border-border/20">
            {[
              ...
              <div key={label} className="text-center group cursor-default">
                <div className="h-14 w-14 rounded-full bg-card/60 backdrop-blur-sm border border-border/30 flex items-center justify-center mx-auto mb-3 group-hover:border-primary/20 group-hover:bg-primary/10 transition-all">
                  <Ic className="h-6 w-6 text-muted-foreground group-hover:text-primary transition-colors" />
                </div>
