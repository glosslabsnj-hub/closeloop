...
export default function ServiceCallFlowSettings({ compact, onSave }: ServiceCallFlowSettingsProps) {
  ...
  const getExampleCustomerRequest = (industry: string | undefined): string => {
    ...
    if (lower.includes("flooring") || lower.includes("floor")) return "I need new flooring installed";
    if (lower.includes("general_contractor") || lower.includes("contractor") || lower.includes("remodel") || lower.includes("renovation")) return "I want to remodel my kitchen";
    if (lower.includes("handyman")) return "I have some repairs I need done around the house";
    if (lower.includes("window") || lower.includes("glass")) return "I need my windows replaced";
    if (lower.includes("pool")) return "I need my pool serviced";
    if (lower.includes("fence")) return "I need a fence installed";
    if (lower.includes("salon") || lower.includes("hair") || lower.includes("barber")) return "I'd like to book a haircut";
    if (lower.includes("nail") || lower.includes("manicure")) return "I'd like to book a manicure";
    if (lower.includes("spa") || lower.includes("massage") || lower.includes("estheti")) return "I'd like to book a massage";
    if (lower.includes("personal_training") || lower.includes("trainer") || lower.includes("gym") || lower.includes("fitness")) return "I'd like to book a personal training session";
    if (lower.includes("dental") || lower.includes("dentist")) return "I need to schedule a cleaning";
    if (lower.includes("medical") || lower.includes("clinic") || lower.includes("doctor")) return "I need to schedule an appointment";
    if (lower.includes("auto") || lower.includes("detailing") || lower.includes("car_wash")) return "I'd like to get my car detailed";
    if (lower.includes("towing") || lower.includes("tow")) return "My car broke down and I need a tow";
    if (lower.includes("real_estate") || lower.includes("realt")) return "I saw your listing and want to schedule a showing";
    if (lower.includes("consulting") || lower.includes("consultant")) return "I'd like to schedule a consultation";
