                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-4 p-4 rounded-lg border bg-card">
                    ...
                    <div className="space-y-3">
                      <h5 className="font-medium">Get Your Flux Receptionist Forwarding Number</h5>
                      <p className="text-sm text-muted-foreground">
                        After connecting, you'll receive a Flux Receptionist number. This is where your calls 
                  ...
                  <div className="flex gap-4 p-4 rounded-lg border bg-card">
                    ...
                    <div className="space-y-3">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Configure your phone carrier to forward calls to your Flux Receptionist number when you're 
                        ...
                        <AccordionItem value="iphone">
                          ...
                          <AccordionContent>
                            <ol className="space-y-2 text-sm text-muted-foreground">
                              ...
                              <li className="flex gap-2">
                                <Badge variant="outline" className="shrink-0">4</Badge>
                                Enter your Flux Receptionist number: <code className="bg-muted px-1 rounded">{exampleNumber}</code>
                              </li>
                            </ol>
                          ...
                          <AccordionContent>
                            <ol className="space-y-2 text-sm text-muted-foreground">
                              ...
                              <li className="flex gap-2">
                                ...
                                Enter your Flux Receptionist number and save
                              </li>
                            </ol>
                          </AccordionContent>
                        </AccordionItem>
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <div>
                  <CardTitle>Get a New Flux Receptionist Number</CardTitle>
                  <CardDescription>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-4 p-4 rounded-lg border bg-card">
                    ...
                    <div className="space-y-2">
                      <h5 className="font-medium">Choose "Get a New Flux Receptionist Number"</h5>
                      <p className="text-sm text-muted-foreground">
                  ...
                  <div className="flex gap-4 p-4 rounded-lg border bg-card">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Your new Flux Receptionist number will be displayed immediately. This is the number 
