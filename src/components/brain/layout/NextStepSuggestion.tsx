...
const NEXT_STEP_MAP: Record<string, Record<BusinessMode | "default", { section: string; label: string; reason: string; timeEstimate?: string }>> = {
  ...
  "operations": {
    default: { section: "rules", label: "Set your policies", reason: "Cancellation, deposits, and limits" },
    service: { section: "rules", label: "Set your policies", reason: "Cancellation, deposits, and limits" },
    dispatch: { section: "rules", label: "Set your rules", reason: "Policies and impound settings" },
    food: { section: "rules", label: "Set your policies", reason: "Refund and order rules" },
    medical: { section: "rules", label: "Set patient policies", reason: "Cancellation and payment terms" },
    general: { section: "rules", label: "Set your policies", reason: "Cancellation and payment terms" },
    sales: { section: "rules", label: "Set your policies", reason: "Returns, warranties, and terms" },
  },
  "rules": {
    default: { section: "training", label: "Customize your AI", reason: "Greeting, FAQs, and knowledge" },
    service: { section: "training", label: "Customize your AI", reason: "Greeting, scripts, and FAQs" },
    dispatch: { section: "training", label: "Customize your AI", reason: "Greeting and caller questions" },
    food: { section: "training", label: "Customize your AI", reason: "Greeting and menu knowledge" },
    medical: { section: "training", label: "Customize your AI", reason: "Scripts and patient FAQs" },
    general: { section: "training", label: "Customize your AI", reason: "Greeting and common questions" },
  ...
  "service-area": {
    default: { section: "rules", label: "Set policies", reason: "Cancellation and payment terms" },
    service: { section: "rules", label: "Set policies", reason: "Cancellation and payment terms" },
    dispatch: { section: "rules", label: "Set policies", reason: "Payment and impound rules" },
    ...
    general: { section: "rules", label: "Set policies", reason: "Cancellation and payment terms" },
    sales: { section: "rules", label: "Set policies", reason: "Return and warranty terms" },
  },
  "policies": {
