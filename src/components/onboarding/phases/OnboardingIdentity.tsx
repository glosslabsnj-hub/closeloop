...
export const OnboardingIdentity = React.memo(function OnboardingIdentity({
  ...
  const SLUG_PLACEHOLDERS: Record<string, string> = {
    ...
    hair_salon: "Bella's Hair Studio",
    salon: "Bella's Hair Studio",
    dental: "Bright Smile Dental",
    hvac: "Comfort Air HVAC",
    "auto-repair": "FastLane Auto Repair",
    auto_repair: "FastLane Auto Repair",
    pizza: "Tony's Pizza",
    towing: "Rapid Tow & Recovery",
    "lawn-care": "GreenPro Landscaping",
    lawn_care: "GreenPro Landscaping",
    landscaping: "GreenPro Landscaping",
    ...
    flooring: "FloorCraft Installations",
    veterinary: "Pawcare Veterinary",
    auto_detailing: "DetailPro Auto Spa",
    "auto-detailing": "DetailPro Auto Spa",
    spa: "Serenity Spa & Wellness",
    medspa: "Radiance Med Spa",
    med_spa: "Radiance Med Spa",
  };
