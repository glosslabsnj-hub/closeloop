...
/**
 * Phase 4: WHEN & WHERE — Business hours + service area
 * Split from the original Phase 2 (OnboardingOfferings) for clarity.
 */
    ...
    <div className="space-y-8">
      <div>
        <h2 className="text-2xl font-semibold tracking-tight">
          Your hours & service area
        </h2>
        <p className="mt-2 text-muted-foreground">
          Your AI uses these to tell callers when you're available and whether you serve their area.
        </p>
      </div>
