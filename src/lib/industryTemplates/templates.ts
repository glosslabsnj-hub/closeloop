...
const plumbingTemplate: IndustryTemplate = {
  ...
  defaults: {
    services: [
      ...
      { name: "Whole-House Repipe", description: "Replace all plumbing pipes throughout the home", base_price_model: "starting_at", starting_price_cents: 450000, duration_minutes: 1440, tags: ["repipe", "pipes", "replacement"] },
      { name: "Water Filtration Install", description: "Install whole-house or point-of-use water filtration system", base_price_model: "starting_at", starting_price_cents: 55000, duration_minutes: 150, tags: ["water filtration", "filter", "water quality"] },
      { name: "Sewer Line Repair", description: "Repair or replace damaged sewer lines", base_price_model: "starting_at", starting_price_cents: 250000, duration_minutes: 480, tags: ["sewer", "repair", "line"] },
      { name: "Water Heater Installation", description: "Install new tank or tankless water heater", base_price_model: "starting_at", starting_price_cents: 150000, duration_minutes: 240, tags: ["water heater", "installation"] },
    ],
    required_questions: [
    ...
    faqs: [
      ...
      { question: "How much does a water filtration system cost?", answer: "Water filtration systems start at $550 for point-of-use installations. Whole-house systems vary based on your water quality and home size — we'll provide a free estimate." },
      { question: "How long does a whole-house repipe take?", answer: "A whole-house repipe typically takes 2-3 days depending on the size of your home and pipe accessibility. We'll provide a detailed timeline during your estimate." },
    ],
    objections: commonObjections,
