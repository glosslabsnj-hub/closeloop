...
const serviceQuestions: ScenarioQuestion[] = [
  ...
  },
  {
    ...
    defaultValue: false,
    group: "core",
    preAnsweredFor: { slugs: ["plumbing", "hvac", "electrical", "towing", "locksmith", "roofing", "pest_control"] },
...
const salesQuestions: ScenarioQuestion[] = [
  {
    ...
    question: "Do you schedule in-person visits or consultations?",
    description: "Office visits, showroom tours, property showings — any scheduled meeting with a prospect",
    defaultValue: true,
    impliesModules: ["booking"],
    group: "core",
    onboardingVisible: true,
  ...
  },
  {
    ...
    label: "Team Routing",
    question: "Should the AI route leads to specific team members?",
    description: "Leads are assigned to named sales reps, agents, or consultants",
    defaultValue: false,
    group: "ai_behavior",
    onboardingVisible: true,
  },
