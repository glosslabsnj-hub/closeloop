...
export const DYNAMIC_VAR_REGISTRY: DynamicVarSpec[] = [
  ...
  },
  {
    ...
    type: "string",
    source: (ctx) => ctx.workflow_config?.dispatch?.luxury_flatbed_recommendation === true ? "true" : "false",
    defaultValue: "false",
    category: "ai_settings",
  },
  {
  ...
  },
  {
    ...
    type: "string",
    source: (ctx) => ctx.workflow_config?.dispatch?.awd_detection_enabled === true ? "true" : "false",
    defaultValue: "false",
    category: "ai_settings",
  },
  {
  ...
  },
  {
    ...
    type: "string",
    source: (ctx) => ctx.workflow_config?.dispatch?.payment_due_message || "",
    defaultValue: "Driver will collect payment when they arrive",
    category: "ai_settings",
    speechReady: true,
  },
  {
  ...
  },
  {
    ...
    type: "string",
    source: (ctx) => ctx.workflow_config?.dispatch?.driver_callback_script || "",
    defaultValue: "Our driver will call you when they're about 10 minutes away",
    category: "ai_settings",
    speechReady: true,
  },
  {
